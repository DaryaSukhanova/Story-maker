...
describe('Authorization Test', () => {
    it('should navigate to login page, perform login, and check graphic editor', async () => {
        ...
        // Здесь необходимо добавить проверку на успешную авторизацию, например:
        // const userProfile = await $('.user-profile');
        // expect(await userProfile.isDisplayed()).toBe(true); // Используем WebdriverIO expect для проверки элемента
